...
namespace FLVER_Editor
{
    ...
    internal class Mono3D : Game
    {
        ...
        {
            FLVER2.Mesh m = Program.flver2.Meshes[targetVertexInfo.meshIndex];
        ...
        {
            FLVER2.Mesh mesh = Program.flver2.Meshes[targetVertexInfo.meshIndex];
            int index = targetVertexInfo.vertexIndex;
        ...
        private void DrawGround()
        {
            ...
            foreach (FLVER.Dummy d in MainWindow.flver2.Dummies)
